...
def converter_dataframe(df, formato_saida):
    ...
    try:
        ...
        # ----------------------------------------------------
            ...
            # XLSX també também é um arquivo binário.
            # Utilizamos BytesIO para mantê-lo em memória.
            buffer = io.BytesIO()
        ...
        raise ValueError(
            f"Erro durante a conversão para "
...
def mostrar_preview(conteudo_convertido, formato_saida):
    ...
    try:
        ...
        # ----------------------------------------------------
            ...
            st.info(
                f"📁 | Arquivo Parquet convertido com sucesso. "
        ...
        # ----------------------------------------------------
            ...
            st.info(
                f"📁 | Arquivo Excel convertido com sucesso. "
                f"Tamanho: {tamanho_kb:.2f} KB."
            )
...
if arquivo is not None:
    ...
    st.subheader("Escolha o formato de saída desejado")
